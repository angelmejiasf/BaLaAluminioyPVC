...
<div class="form-container">
  ...
  <form action="/public/index.php?url=admin/actualizarUsuario" method="POST">
    ...
    <input type="text" name="telefono" required pattern="^\d{8}$" title="El teléfono debe tener exactamente 8 números" value="<?= htmlspecialchars($usuario['telefono']) ?>" required>
