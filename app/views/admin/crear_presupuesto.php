...
<div class="form-container">
  ...
  <form action="/public/index.php?url=admin/guardarPresupuesto" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="numero_presupuesto">

    <label for="descripcion">Descripción</label>
    <textarea name="descripcion" rows="4" cols="50" placeholder="Descripción del presupuesto..."></textarea>

    <label for="precio">Precio</label>
    <input type="number" name="precio" step="0.00" placeholder="0.00">
